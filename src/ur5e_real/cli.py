...
def _parser() -> argparse.ArgumentParser:
    ...
    infer_dp.add_argument("--chunks", type=int, default=0, help="live chunks; 0 means until Ctrl+C (default)")
    infer_dp.add_argument("--gpu", default="0")
    infer_dp.add_argument("--no-gripper", action="store_true")
    infer_dp.add_argument("--backend", choices=("socket", "rtde"), default="rtde")
    infer_dp.add_argument("--smooth-alpha", type=float, default=0.7)
    infer_dp.add_argument("--max-linear-speed", type=float, default=0.40)
    infer_dp.add_argument("--diffusion-steps", type=int, default=10)
